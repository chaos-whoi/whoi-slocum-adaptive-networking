...
NETWORK_LOG_EVERY_SECS = float(os.environ.get("NETWORK_LOG_EVERY_SECS", 5))
NETWORK_IFACES_DISCOVERY_EVERY_SECS = float(os.environ.get("NETWORK_IFACES_DISCOVERY_EVERY_SECS", 2))

CHANNELS_LOG_EVERY_SECS = float(os.environ.get("CHANNELS_LOG_EVERY_SECS", 5))
