# TODO: implement discovery helper class here
from adanet.constants import ZEROCONF_PREFIX

if __name__ == '__main__':
    """
    Example of browsing all services.
    """

    import asyncio
    from typing import Optional, cast

    from zeroconf import IPVersion, ServiceStateChange, Zeroconf, ServiceListener
    ...
    class AsyncRunner:
        ...
        async def async_run(self) -> None:
            self.aiozc = AsyncZeroconf(interfaces=["10.42.0.1"], ip_version=IPVersion.V4Only)
    ...
    try:
        ...
        loop.run_until_complete(async_close(runner))
